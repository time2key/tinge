...
abstract class DispatcherModule {
     ...
     *
     * This will look for an [AutoGeneratedDispatcherModuleInternals] corresponding with this class, which
     * will have been generated by [ServerPathAnnotationProcessor] and get precompiled values
     * out of that.
     *
     * @param internals
     * [AutoGeneratedDispatcherModuleInternals] containing auto generated code associated with this
     * source class.
     *
    ...
    fun setupAnnotatedFunctions(
            internals: AutoGeneratedDispatcherModuleInternals?,
            canUseReflectionFallback: Boolean) {
        serverPathAnnotatedFunctions.clear()

        if (internals != null) {
            serverPathAnnotatedFunctions.addAll(
                    internals.getServerPathAnnotatedFunctions(this))
        } else if (canUseReflectionFallback) {
            ...
            throw RuntimeException("The ModularMockWebServer annotation processor did not run.\n" +
                    "Add the dependency to gradle with annotationProcessor (Java) or kapt (Kotlin).\n" +
                    "\n" +
                    "Alternatively, use the fallback multiModuleDispatcher.canUseReflectionFallback = true\n" +
    ...
    protected class ReflectionObtainedServerPathAnnotatedFunction(
        ...
        override fun evaluateRequest(request: RecordedRequest): MockResponse {
            ...
            return function.call(dispatcherModule, request, *groupValues)
        }
