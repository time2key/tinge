...
import com.time2key.modularmockserver.internal.AutoGeneratedClassMapperWormhole
...
class MultiModuleDispatcher: Dispatcher() {
    ...
    fun addModule(dispatcherModule: DispatcherModule) {
        dispatcherModule.setupAnnotatedFunctions(
                AutoGeneratedClassMapperWormhole.getInternalsForClass(dispatcherModule::class.java),
                canUseReflectionFallback)
